$(document).ready(function() {
    ...
    $(".search-input").keyup(function() {
        ...
        $.getJSON("https://www.omdbapi.com/?", { apikey: "1d27a6fa", s: search }, function(data) {
            if (data.Search !== undefined) {
                $.each(data.Search, function(index, value) {
                    if (index < 2) {
                        $.getJSON("https://www.omdbapi.com/?", { apikey: "1d27a6fa", i: value.imdbID }, function(movieData) {
                            if (movieData) {
                                results += '<div class="result row p-1">'
                                results += '<div class="col-sm-5"><img src=' + movieData.Poster + ' style=" " /></div>'
                ...
                $.each(listData.Search, function(index, value) {
                    $.getJSON("https://www.omdbapi.com/?", { apikey: "fd161998", i: value.imdbID }, function(listMovieData) {
                        if (listMovieData) {
                            ...
                            listResults += '<div class="col-md-6"><img src="' + listMovieData.Poster + '" style="" /></div>'
